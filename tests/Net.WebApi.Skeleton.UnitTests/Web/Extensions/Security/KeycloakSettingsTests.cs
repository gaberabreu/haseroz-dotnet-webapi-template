...
namespace Net.WebApi.Skeleton.UnitTests.Web.Extensions.Security;
...
public class KeycloakSettingsTests
{
    ...
    public void Given_ValidProperties_When_CreatingInstance_Then_ValuesAreSetProperly()
    {
        ...
        var wellKnownConfigUrl = "http://localhost:18080/realms/realm-test/.well-known/openid-configuration";
        ...
        Assert.Equal(wellKnownConfigUrl, keycloakConfig.WellKnownConfigUrl);
    }
}
